...
{
    #[rt(name: 'app_route_index', methods: ['GET'])]
    ...
    #[rt('/new', name: 'app_route_new', methods: ['GET', 'POST'])]
    ...
    #[rt('/{id}', name: 'app_route_show', methods: ['GET'])]
    ...
    #[rt('/{id}/edit', name: 'app_route_edit', methods: ['GET', 'POST'])]
    ...
    #[rt('/{id}', name: 'app_route_delete', methods: ['POST'])]

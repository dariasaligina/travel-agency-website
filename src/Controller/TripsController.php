...
{
    #[rt(name: 'app_trips_index', methods: ['GET'])]
    ...
    #[rt('/new', name: 'app_trips_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        $trip = new Trips();
        $form = $this->createForm(TripsForm::class, $trip);
    ...
    #[rt('/{id}', name: 'app_trips_show', methods: ['GET'])]
    ...
    #[rt('/{id}/edit', name: 'app_trips_edit', methods: ['GET', 'POST'])]
    ...
    #[rt('/{id}', name: 'app_trips_delete', methods: ['POST'])]
